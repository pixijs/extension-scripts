 ...
 */
export const bump = async (currentVersion) =>
{
    const { bump, custom, confirmed } = await inquirer.prompt([{
        name: 'bump',
        type: 'list',
    ...
    {
        throw new Error(`Next version (v${nextVersion}) is less than current version (v${currentVersion}).`);
    }
